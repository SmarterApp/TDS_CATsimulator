YUI.add('reportsummarystats', function (Y) {
    Y.ReportSummaryStats = function () {
            //ids
        var _strDivReport = "#reportSummaryStats",
            _strBtnClose = "#button-close",
            //report tables
            _strReportTable1 = "#table-report-1",
        ...
        getReport = function () {
            ...
            var cfg = {
                ...
                on: {
                    ...
                    success: function(id, xhr, arguments) {
                        ...
                        _dataCorr2Table = summaryStatsReport.Tables[2];
            ...
            Y.io("Services/WebSimXHR.ashx/GetReportSummaryStats", cfg);
        },
        ...
        updateBiasTable = function () {
            populateTable(_strReportTable1, _dataBiasTable);
        },

        updateCorrelationsTable = function () {
            populateTable(_strReportTable2, _dataCorrelationsTable);
        },

        updateCorr2Table = function () {
            populateTable(_strReportTable3, _dataCorr2Table);
        },
...
YUI().use("node", "io", "dump", "reportsummarystats", function (Y) {
    var summaryStats = Y.ReportSummaryStats;
    summaryStats.init();
});